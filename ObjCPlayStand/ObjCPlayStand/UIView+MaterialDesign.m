...
//muku
+ (void)mdInflateTransitionFromView:(UIView *)fromView toView:(UIView *)toView originalPoint:(CGPoint)originalPoint duration:(NSTimeInterval)duration withInfalting:(BOOL)inf completion:(void (^)(void))block {
    if (fromView.superview) {
        ...
        [containerView mdAnimateAtPoint:convertedPoint backgroundColor:toView.backgroundColor duration:duration * UIViewMaterialDesignTransitionDurationCoeff inflating:inf zTopPosition:YES shapeLayer:nil completion:^{
